...
<html>
    ...
    <body class="sidebar-mini sidebar-open" style="height: auto;">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper" style="min-height: 1970.25px;">
                ...
                <section class="content-header">
                    ...
                    <a href="srvUsuario?accion=nuevo" class="btn btn-success ml-3">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <table id="example1" class="table table-bordered table-striped dataTable dtr-inline collapsed" role="grid" aria-describedby="example1_info">
                                                    <thead>
                                                        <tr role="row">
                                                            <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">IDUsuario</th>
                                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Usuario</th>
                                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Clave</th>
                                                            ...
                                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">Cargo</th>
                                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">Acciones</th>
                                                        </tr>
                                                    </thead>
                                                            ...
                                                            <td>
                                                                ...
                                                                <c:choose>
                                                                    <c:when test="${user.estado == true}">
                                                                        <input type="hidden" id="item" value="${user.idUsuario}">
                                                                        <a id="desactivarUsuario" href="srvUsuario?cambiar=desactivar&cod=${user.idUsuario}" class="btn btn-danger"  data-toggle="tooltip" title="Desactivar" data-original-title="Desactivar">
                                                                    ...
                                                                    <c:otherwise>
                                                                        <input type="hidden" id="item" value="${user.idUsuario}">
                                                                        <a id="activarUsuario" href="srvUsuario?cambiar=activar&cod=${user.idUsuario}" class="btn btn-primary" data-toggle="tooltip" title="Activar" data-original-title="Activar">
