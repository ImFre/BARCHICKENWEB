                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <a class="nav-link" data-toggle="dropdown" href="#">
                            ...
                            <span class="badge badge-warning navbar-badge">Cerrar Session</span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                            <span class="dropdown-item dropdown-header">Usted es:</span>
                            <div class="dropdown-divider"></div>
                           
                            <div class="dropdown-divider"></div>
                            <a href="srvUsuario?accion=cerrar" class="dropdown-item">
                                <i class="fas fa-users mr-2"></i> ${usuario.cargo.nombreCargo}
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        ...
                        <div class="info">
                            <p>
                                ...
                                <a href="#" class="d-block">Bienvenido(a) - ${usuario.nombreUsuario}</a>
